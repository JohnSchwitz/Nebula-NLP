...
<template>
  <Vueform
    :display-errors="true"
    method="POST"
    endpoint="/form-submissions-api/v2/form-submission"
    :display-messages="true"
    add-class="vf-vue-upload"
  >
    <StaticElement
      name="divider"
      tag="hr"
    ...
    <StaticElement
      name="h3"
      tag="h3"
      content="Input Story Name"
      align="center"
    />
    <StaticElement
      name="h3_1"
      tag="h4"
      content="Submit Button to SAVE Story for later viewing"
      align="center"
    />
    <StaticElement
      name="h3_2"
      tag="h4"
      content="PDF Button to download a PDF"
      align="center"
    />
    <StaticElement
      name="link"
      content="https://nebula-nlp.com"
      tag="a"
      href="https://nebula-nlp.com"
    />
    <TextElement
      name="Story Name"
      placeholder="Please Enter the Story Name"
      :rules="[
        'required',
      ]"
      field-name="Story Name"
      label="Story Name"
    />
    <TextareaElement
      name="Story"
  ...
  <Vueform endpoint="asyn-function-api/v2/pdf-download" method="post"> 
    <ButtonElement
      name="PDFDownload"
      button-label="PDF"
      align="center"
